...
import ProductAddAndEditModal from "@/features/products/components/ProductAddEditModal";
...
import {
  ...
  getAllProducts,
  updateProduct,
} from "@/features/products/actions/action.products";
import { ProductType, productTypeForCreateAndEdit } from "@/types/product";
import DeleteConfirmationDialog from "@/components/ui/ConfirmationModal";
...
import SortProduct from "@/features/products/components/SortComponet";
import ShowProductModal from "@/features/products/components/ShowProductModal";
...
const AdminProductPage = () => {
  ...
  const [productToShow,setProductToShow] = useState<ProductType | null> (null)
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      setError("Failed to load product. Please try again letter!");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleProductShowClick = (product:ProductType) =>{
  ...
  return (
    <div className="p-4">
      <div className="flex flex-col gap-4">
        ...
        {loading ? (
          ...
          <>
            <ProductTable
              ...
              onProductShow = {handleProductShowClick}
            />
            <Pagination
       ...
       <ShowProductModal isOpen={productShowModal} setProductShowModal={setProductShowModal} product={productToShow} />
