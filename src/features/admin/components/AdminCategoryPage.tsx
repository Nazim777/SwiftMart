...
import {
  ...
  getAllCategories,
  updateCategory,
} from "@/features/category/actions/action.category";
...
import SortCategory from "@/features/products/components/SortComponet";
...
const AdminCategoriesPage = () => {
  ...
  const fetchCategories = async () => {
    ...
    try {
      ...
      setError('Failed to load categories. Please try again leter!')
    } finally {
      setLoading(false);
    }
  };
  ...
  useEffect(() => {
    fetchCategories();
  }, [curretnPage, debouncedSearch, sortOrder]);
