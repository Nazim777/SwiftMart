...
} from "@/features/cart/actions/action.cart";
import ButtonLoader from "@/components/ui/ButtonLoader";
import CartPageSkeleton from "@/features/cart/components/CartSkeletonLoader";
...
const CartPage = () => {
  ...
  const updateQuantity = async (
    ...
    try {
      ...
      toast.error('Error updating quantity...', { theme: 'colored' })
    } finally {
