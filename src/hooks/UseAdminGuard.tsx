...
import { getLoggedInUser } from "@/features/user/actions/action.user"; // Adjust the path to your API function
import { User } from "@/features/user/components/AvatarDisplay";
