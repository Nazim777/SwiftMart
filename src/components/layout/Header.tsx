...
export default function Header() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-white dark:bg-gray-900 shadow-md' : 'bg-transparent'
        }`}
    >
...
// import { getLoggedInUser, syncUser } from "@/features/user/actions/action.user";
// import { User } from './AvatarDisplay';
// import { ShoppingCart } from 'lucide-react'; // Cart icon
// import { ProductContext } from "@/components/providers/Product.Context';
// import { useRouter } from 'next/navigation';
// import { DropdownMenu, DropdownMenuItem, DropdownMenuTrigger, DropdownMenuContent } from "@/components/ui/DropdownMenu";  // ShadCN UI dropdown
